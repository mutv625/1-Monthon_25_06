...
[System.Serializable]
public class SerDictionary<K, V> : Dictionary<K, V>, ISerializationCallbackReceiver
{
    [System.Serializable]
...
[System.Serializable]
public class SerDictionary<V> : SerDictionary<string, V>
{
    public override string DefaultKey => string.Empty;
}
[System.Serializable]
public class SerDictionaryC<K, V> : SerDictionary<K, V> where K : new()
{
